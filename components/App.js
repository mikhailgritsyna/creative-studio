...

{
  ...
  "creativeConcept": "...",
  ""imagePrompt": "A detailed DALL-E prompt in English for a 9:16 vertical advertising banner. Include bold text overlays with the exact headline, subheadline and CTA from the brief. Match visual style, colors and composition from the references. Make it look like a real finished ad creative ready to publish on Facebook/Instagram.""
}`;
